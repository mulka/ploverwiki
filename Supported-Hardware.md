...
| [Stenoboard](http://utopen.com)    | Utopen (Emanuele Caruso) | Open source hardware. The first open source steno machine on the market, released in 2014. The Stenoboard's keys actuate like mouse-clicks instead of a keyboard or lever-machine. |
